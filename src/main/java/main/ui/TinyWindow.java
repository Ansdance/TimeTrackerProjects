...
public class TinyWindow extends JWindow implements DropTargetListener {
    ...
    private void createWindow() {
        ...
        cmp = new JComponent() {
            ...
            public void paint(Graphics g) {
                ...
                if (activeProject == null) {
                    g.drawString("No project active!", 10, 20);
                    return;
                }
    ...
    public void drop(DropTargetDropEvent dtde) {
        ...
        try {
            ...
            if (myString.indexOf('@') > -1 || myString.indexOf('_') > -1) {
                JOptionPane.showMessageDialog(cwp, "The comment may not contain @ and _.",
                        "Comment cannot be saved", JOptionPane.ERROR_MESSAGE);
                return;
            }
        ...
        if (commentForDay == null || commentForDay.trim().length() == 0) {
            ...
            int showOptionDialog = JOptionPane.showOptionDialog(cmp,
                    "How about the comment? (" + myString + ") be proceeded ? ", "Comment already exists",
                    JOptionPane.OK_OPTION, JOptionPane.INFORMATION_MESSAGE, null,
                    new String[]{"append", "Substitute", "Abort"}, new String("Append"));
    ...
    private void showPopup(MouseEvent e, PopupMenu p) {
        ...
        menuFrame.setLocation(-200, -200);// the menu frame should not appear on the screen at all
        ...
        System.out.println("egetxy " + e.getX()+"/"+e.getY());  // Mousepos relative in Tinywindow
