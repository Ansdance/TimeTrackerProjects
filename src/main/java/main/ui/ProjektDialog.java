...
public class ProjektDialog extends JDialog implements ActionListener {
    ...
    private void init() {
        ...
        setTitle("Set up project");

        mainpanel.add(tf_name = new JTextField(15));
        TitledBorder titledBorder = new TitledBorder("ProjectName");
        ...
        tf_number.setBorder(new TitledBorder("ProjectNumber"));
        ...
        pnl_button.add(btn_abbrechen = new JButton("Abort"));
