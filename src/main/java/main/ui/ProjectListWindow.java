...
public class ProjectListWindow extends JFrame {
    ...
    protected final static String _TITLE = "ProjectClock2000";
    ...
    private JComboBox<String> exportCombo = new JComboBox<String>(new String[]{"Export", "Notepad", "Table"});
    ...
    private void init() {
        ...
        buttonpanel.add(btnCreateProject = new JButton("New"));
        ...
        buttonpanel.add(btnDeleteProject = new JButton("erasing"));
        ...
        buttonpanel.add(rbStayOnTop = new JCheckBox("<HTML>Mini window<br>when<br>minimized</HTML>"));
        ...
        togglePlayState(); // once to draw the button
//		togglePlayState(); // once to start the app
        pack();
        setVisible(true);
    ...
    public void togglePlayState() {
        ...
        if (togglePausePlayMenuItem != null) {
            togglePausePlayMenuItem.setLabel(pause ? "stop time" : "continue counting time");
    ...
    private void addTrayIcon() {
        ...
        // The popup menu must be swapped before displaying
    ...
    public PopupMenu createPopup() {
        ...
        projectNamesMenu = new Menu("choose project...");
        final MenuItem itm_maximize = new MenuItem("Show main window");
        ...
        final MenuItem itm_showMiniwindow = new MenuItem("Show mini window");
        ...
        togglePausePlayMenuItem = new MenuItem(!isPausing() ? "Pause" : "Break over");
        ...
        if (getActiveProject() != null) {
            final MenuItem editCommentItem = new MenuItem(
                    getActiveProject().getCurrentWorkAmount().hasCommentForDay() ? "Change comment.."
                    : "Create comment..");
        ...
        final MenuItem exportItem = new MenuItem("Show table");
        ...
        menu.addSeparator();
        final MenuItem exitItem = new MenuItem("End");
    ...
    private void fillProjectMenu() {
        ...
        final MenuItem menuItem = new MenuItem("New project ...");
        ...
        menuItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(final ActionEvent arg0) {
                ...
                if (name.trim().length() < 1) {
                    JOptionPane.showMessageDialog(null,
                            "Project cannot be created without a name.");
                    return;
                }
    ...
    public void drawShowroom() {
        ...
        final JLabel lblProjectname = new JLabel("  Project");
    ...
    public void updateProject(Project project) {
        ...
        getRadioButton(project).setToolTipText("project number: " + project.getProjektNumber());
